...
interface MoviesRepository {
    ...
    fun getMovieFromNetServer(movies: MutableList<Movies>, callback: retrofit2.Callback<MovieList>) // DetailPersonsViewModel
    ...
    fun getMovieFromSQLite(movies: MutableList<Movie>, callback: Callback<MutableList<Movie>>) // DetailPersonsViewModel
