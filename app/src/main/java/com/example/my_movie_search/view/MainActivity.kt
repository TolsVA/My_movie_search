...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val iconsPortraitWorld: TypedArray = resources.obtainTypedArray(R.array.world_cover_port)
        val iconsLandscapeWorld: TypedArray = resources.obtainTypedArray(R.array.world_cover_land)
